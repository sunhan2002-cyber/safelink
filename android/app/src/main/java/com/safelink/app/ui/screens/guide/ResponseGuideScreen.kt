            ...
            if (isSextortion(detectionViewModel)) {
                ...
                GuideStepList(
                    steps = listOf(
                        ...
                        // 몸캠피싱 피해자는 남성이 많다. 1366은 여성긴급전화라 남성 피해자가 "나는 해당 없다"고 느끼기 쉬워서,
                        // 성별과 관계없이 이용할 수 있는 곳(디지털성범죄피해자지원센터·경찰)을 먼저 적는다.
                        "혼자 있지 마세요" to "성별과 관계없이 02-735-8994(디지털성범죄피해자지원센터)와 112에서 도와줍니다. 청소년은 1388, 여성은 1366도 이용할 수 있어요. 창피한 일이 아니니 가족이나 믿을 만한 사람에게 알려 주세요."
                    )
                )
            }
